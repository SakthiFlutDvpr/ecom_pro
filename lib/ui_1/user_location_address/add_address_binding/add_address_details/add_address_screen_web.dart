...
class AddAddressDetailsWeb extends CoreWidgets {
  const AddAddressDetailsWeb({super.key});

  @override
  CoreWidgetsState<AddAddressDetailsWeb> createState() =>
      _AddAddressDetailsWebState();
}

class _AddAddressDetailsWebState
    extends CoreWidgetsState<AddAddressDetailsWeb> {
  FocusNode focusNode = FocusNode();

  @override
  Widget build(BuildContext context) {
    final hintStyle = TextStyle(
        fontFamily: "Poppins", fontSize: 4.sp, color: AppColors().sixgrey);
