...
class CategoryScreenMob extends CoreWidgets {
  const CategoryScreenMob({super.key});

  @override
  CoreWidgetsState<CategoryScreenMob> createState() =>
      _CategoryScreenMobState();
}

class _CategoryScreenMobState extends CoreWidgetsState<CategoryScreenMob> {
  @override
                    ...
                    children: [
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            // GoRouter.of(context)
                            //     .push(SubCategoryScreen.routeName);
                          },
                          child: SizedBox(
                            child: Card(
