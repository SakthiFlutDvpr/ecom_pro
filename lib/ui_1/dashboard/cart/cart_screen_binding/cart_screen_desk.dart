...
class CartScreenDesk extends CoreWidgets {
  const CartScreenDesk({super.key});
  @override
  CoreWidgetsState<CartScreenDesk> createState() => _CartScreenMobState();
}

class _CartScreenMobState extends CoreWidgetsState<CartScreenDesk> {
  @override
                    ...
                    children: [
                      ...
                      Container(
                        padding: EdgeInsets.symmetric(
                            horizontal: width * 0.10, vertical: 10.h),
                        width: width,
                        height: 250.h,
                        color: Colors.white,
                        child: Column(
                          children: [
                            ListTile(
                              ...
                              title: Padding(
                                padding: EdgeInsets.only(right: width * 0.30),
                                child: RichText(
                                    maxLines: 1,
