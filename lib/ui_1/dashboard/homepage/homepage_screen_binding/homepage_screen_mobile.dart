...
class HomepageScreenMob extends CoreWidgets {
  const HomepageScreenMob({super.key});

  @override
  CoreWidgetsState<HomepageScreenMob> createState() =>
      _DashboardScreenMobState();
}

class _DashboardScreenMobState extends CoreWidgetsState<HomepageScreenMob> {
  @override
