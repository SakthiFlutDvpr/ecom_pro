...
class CustomerScreenMob extends StatefulWidget {
  const CustomerScreenMob({super.key});

  @override
  State<CustomerScreenMob> createState() => _CustomerScreenMobState();
}

class _CustomerScreenMobState extends State<CustomerScreenMob> {
  @override
            ...
            child: state is SuccessState
                ? Container(
                    ...
                    padding: EdgeInsets.symmetric(
                        horizontal: width * 0.05, vertical: 20.h),
                    child: Column(
