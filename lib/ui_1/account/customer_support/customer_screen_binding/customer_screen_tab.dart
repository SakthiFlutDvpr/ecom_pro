...
class CustomerScreenTab extends StatefulWidget {
  const CustomerScreenTab({super.key});

  @override
  State<CustomerScreenTab> createState() => _CustomerScreenTabState();
}

class _CustomerScreenTabState extends State<CustomerScreenTab> {
  @override
            ...
            child: state is SuccessState
                ? Container(
                    ...
                    padding: EdgeInsets.symmetric(
                        horizontal: width * 0.05, vertical: 50.h),
                    child: Column(
