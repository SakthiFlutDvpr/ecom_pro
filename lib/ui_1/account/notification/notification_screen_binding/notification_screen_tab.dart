...
class NotificationScreenTab extends CoreWidgets {
  const NotificationScreenTab({super.key});
  @override
  CoreWidgetsState<NotificationScreenTab> createState() =>
      _NotificationScreenTabState();
}

class _NotificationScreenTabState
    extends CoreWidgetsState<NotificationScreenTab> {
  @override
