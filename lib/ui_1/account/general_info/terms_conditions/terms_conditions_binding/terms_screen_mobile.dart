...
class TermsConditionScreenMob extends CoreWidgets {
  const TermsConditionScreenMob({super.key});
  @override
  CoreWidgetsState<TermsConditionScreenMob> createState() =>
      _TermsConditionScreenMobState();
}

class _TermsConditionScreenMobState
    extends CoreWidgetsState<TermsConditionScreenMob> {
  @override
