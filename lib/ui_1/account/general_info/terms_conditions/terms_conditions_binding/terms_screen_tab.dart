...
class TermsConditionScreenTab extends CoreWidgets {
  const TermsConditionScreenTab({super.key});
  @override
  CoreWidgetsState<TermsConditionScreenTab> createState() =>
      _TermsConditionScreenTabState();
}

class _TermsConditionScreenTabState
    extends CoreWidgetsState<TermsConditionScreenTab> {
  @override
