...
class GeneralScreenTab extends CoreWidgets {
  const GeneralScreenTab({super.key});
  @override
  CoreWidgetsState<GeneralScreenTab> createState() => _GeneralScreenTabState();
}

class _GeneralScreenTabState extends CoreWidgetsState<GeneralScreenTab> {
  @override
