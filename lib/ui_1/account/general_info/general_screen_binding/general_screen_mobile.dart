...
class GeneralScreenMob extends CoreWidgets {
  const GeneralScreenMob({super.key});
  @override
  CoreWidgetsState<GeneralScreenMob> createState() => _GeneralScreenMobState();
}

class _GeneralScreenMobState extends CoreWidgetsState<GeneralScreenMob> {
  @override
