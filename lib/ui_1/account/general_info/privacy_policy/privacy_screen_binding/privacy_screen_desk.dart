...
class PrivacyPolicyScreenDesk extends CoreWidgets {
  const PrivacyPolicyScreenDesk({super.key});
  @override
  CoreWidgetsState<PrivacyPolicyScreenDesk> createState() =>
      _PrivacyPolicyScreenDeskState();
}

class _PrivacyPolicyScreenDeskState
    extends CoreWidgetsState<PrivacyPolicyScreenDesk> {
  @override
  Widget build(BuildContext context) {
    final titleStyle = TextStyle(
        ...
        height: 1.75);
    final paraStyle =
        TextStyle(fontFamily: "Poppins", fontSize: 5.sp, height: 1.75);
