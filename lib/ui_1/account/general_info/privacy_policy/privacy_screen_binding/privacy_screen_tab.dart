...
class PrivacyPolicyScreenTab extends CoreWidgets {
  const PrivacyPolicyScreenTab({super.key});
  @override
  CoreWidgetsState<PrivacyPolicyScreenTab> createState() =>
      _PrivacyPolicyScreenTabState();
}

class _PrivacyPolicyScreenTabState
    extends CoreWidgetsState<PrivacyPolicyScreenTab> {
  @override
  Widget build(BuildContext context) {
    final titleStyle = TextStyle(
        ...
        height: 1.75);
    final paraStyle =
        TextStyle(fontFamily: "Poppins", fontSize: 6.sp, height: 1.75);
