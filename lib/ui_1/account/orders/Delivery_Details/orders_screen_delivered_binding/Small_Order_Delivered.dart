...
class SmallDelivered extends StatefulWidget {
  const SmallDelivered({super.key});

  @override
  State<SmallDelivered> createState() => _SmallDeliveredState();
}

class _SmallDeliveredState extends State<SmallDelivered> {
  @override
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        String imageUrl = (state.successResponse as Orderlist)
                            .imageUrls[index];
                        // String productname =
                        //     (state.successResponse as Orderlist)
                        //         .productname[index];
                        // String date =
                        //     (state.successResponse as Orderlist).date[index];
                        // String orderdetails =
                        //     (state.successResponse as Orderlist)
                        //         .orderdetails[index];
                        // String time =
                        //     (state.successResponse as Orderlist).time[index];
                        // String amount =
                        //     (state.successResponse as Orderlist).amount[index];
                        return Column(
                          children: [
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
