...
class SmallOrderCancelled extends StatefulWidget {
  const SmallOrderCancelled({super.key});

  @override
  State<SmallOrderCancelled> createState() => _SmallOrderCancelledState();
}

class _SmallOrderCancelledState extends State<SmallOrderCancelled> {
  @override
