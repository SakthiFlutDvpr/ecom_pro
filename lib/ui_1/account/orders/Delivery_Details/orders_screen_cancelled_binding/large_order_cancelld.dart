...
class LargeOrderCancelld extends StatefulWidget {
  const LargeOrderCancelld({super.key});

  @override
  State<LargeOrderCancelld> createState() => _LargeOrderCancelldState();
}

class _LargeOrderCancelldState extends State<LargeOrderCancelld> {
  @override
    ...
    return BlocConsumer<Order_DetailsBloc, BaseState>(
      ...
      builder: (context, state) {
        ...
        return FlutterScaffold(
          isLoading: false,
          isAppBar: true,
          toolBarTitleString: "          Order Again",
