...
class SubCategoryScreenMob extends CoreWidgets {
  const SubCategoryScreenMob({super.key});
  @override
  CoreWidgetsState<SubCategoryScreenMob> createState() =>
      _SubCategoryScreenMobState();
}

class _SubCategoryScreenMobState
    extends CoreWidgetsState<SubCategoryScreenMob> {
  @override
